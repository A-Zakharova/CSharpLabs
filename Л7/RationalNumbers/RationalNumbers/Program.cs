...
namespace RationalNumbers
{
    class Program
    {
        ...
        public static RationalNum Enter()
        {
            int a;
        ...
        public static RationalNum GetFraction()
        {
            ...
            RationalNum r = RationalNum.GetFractionFromStr(str);
            return r;
        }
        ...
        public static RationalNum GetNum()
        {
            Console.WriteLine("Number: ");
            string str = Console.ReadLine();
            double a = CheckNum(str);

            RationalNum r = RationalNum.GetNumberFromStr(a);
            return r;
        }
